...
var GlowBlurPostProcess = /** @class */ (function (_super) {
    tslib_1.__extends(GlowBlurPostProcess, _super);
...
var HighlightLayer = /** @class */ (function (_super) {
    tslib_1.__extends(HighlightLayer, _super);
    /**
    ...
    function HighlightLayer(name, scene, options) {
        ...
        // Adapt options
        _this._options = tslib_1.__assign({ mainTextureRatio: 0.5, blurTextureSizeRatio: 0.5, blurHorizontalSize: 1.0, blurVerticalSize: 1.0, alphaBlendingMode: Constants.ALPHA_COMBINE, camera: null, renderingGroupId: -1 }, options);
