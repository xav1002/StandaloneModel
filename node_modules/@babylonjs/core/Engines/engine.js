...
var Engine = /** @class */ (function () {
    ...
    function Engine(canvasOrContext, antialias, options, adaptToDeviceRatio) {
        ...
        this._viewportCached = new Vector4(0, 0, 0, 0);
        ...
        var onInternalError = function (message, exception) {
            ...
            if (loader) {
                ...
                if (fallbackUrl) {
                    ...
                    Tools.Warn(loader.constructor.name + " failed when trying to load " + texture.url + ", falling back to the next supported loader");
            ...
            if (!customFallback) {
                ...
                if (Tools.UseFallbackTexture) {
                    _this.createTexture(Tools.fallbackTexture, noMipmap, texture.invertY, scene, samplingMode, null, null, buffer, texture);
                }
            }
            if (onError) {
    ...
    Engine.prototype._uploadDataToTextureDirectly = function (texture, imageData, faceIndex, lod) {
        ...
        var lodMaxWidth = Math.round(Scalar.Log2(texture.width));
        var lodMaxHeight = Math.round(Scalar.Log2(texture.height));
    ...
    Engine.prototype._loadFile = function (url, onSuccess, onProgress, offlineProvider, useArrayBuffer, onError) {
        var _this = this;
        var request = Tools.LoadFile(url, onSuccess, onProgress, offlineProvider, useArrayBuffer, onError);
